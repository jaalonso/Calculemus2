...
+ Calculemus: [[~/alonso/estudio/Calculemus2/textos/Demostracion_por_congruencia.md][En ℝ, |a| = |a - b + b|]] (En [[~/alonso/estudio/Calculemus2/src/Demostracion_por_congruencia.lean][Lean4]]).
...
+ M30 [[./src/Demostracion_por_extensionalidad.lean][Las funciones f(x,y) = (x + y)² y g(x,y) = x² + 2xy + y² son iguales]].
