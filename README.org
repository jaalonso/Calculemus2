...
+ V01 [[./textos/Eliminacion_doble_negacion.md][¬¬P → P]] (En [[./src/Eliminacion_doble_negacion.lean][Lean4]]).
+ L04 [[./textos/Introduccion_doble_negacion.md][P → ¬¬P]] (En [[./src/Introduccion_doble_negacion.lean][Lean4]]).
+ M05 [[./textos/CN_no_acotada_superiormente.md][Si f no está acotada superiormente, entonces (∀a)(∃x)[f(x) > a]​]] (En [[./src/CN_no_acotada_superiormente.lean][Lean4]]).
+ X06 [[./textos/CS_de_acotada_superiormente.md][Si ¬(∀a)(∃x)[f(x) > a]​, entonces f está acotada superiormente]] (En [[./src/CS_de_acotada_superiormente.lean][Lean4]]).
+ J07 [[./textos/CN_de_no_monotona.md][Si f no es monótona, entonces ∃x∃y[x ≤ y ∧ f(y) < f(x)]​]] (En [[./src/CN_de_no_monotona.lean][Lean4]]).
+ V08 [[./textos/Principio_de_explosion.md][Si 0 < 0, entonces a > 37 para cualquier número a]] (En [[./src/Principio_de_explosion.lean][Lean4]]).
+ L11 [[./textos/Introduccion_de_la_conjuncion.md][{x ≤ y, y ≰ x} ⊢ x ≤ y ∧ x ≠ y]] (En [[./src/Introduccion_de_la_conjuncion.lean][Lean4]]).
+ M12 [[~/alonso/estudio/Calculemus2/textos/Eliminacion_de_la_conjuncion.md][x ≤ y ∧ x ≠ y ⊢ y ≰ x]] (En [[~/alonso/estudio/Calculemus2/src/Eliminacion_de_la_conjuncion.lean][Lean4]]).
+ X13 [[./textos/Uso_de_conjuncion.md][Si (m ∣ n ∧ m ≠ n), entonces (m ∣ n ∧ ¬(n ∣ m))]] (En [[./src/Uso_de_conjuncion.lean][Lean4]]).
+ J14 [[./textos/Entre_2_y_3.md][(∃x ∈ ℝ)[2 < x < 3]​]] (En [[./src/Entre_2_y_3.lean][Lean4]]).
+ V15 [[./textos/Menor_por_intermedio.md][Si (∃z ∈ ℝ)[x < z < y], entonces x < y]] (En [[./src/Menor_por_intermedio.lean][Lean4]]).
