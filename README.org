...
* Latest exercises
+ [[./textos/Sum_of_arithmetic_progression.md][Proofs of a+(a+d)+(a+2d)+···+(a+nd)=(n+1)(2a+nd)/2]] (In [[./src/Sum_of_arithmetic_progression.lean][Lean]] and [[./thy/Sum_of_arithmetic_progression.thy][Isabelle]]).
