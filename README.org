...
+ M30 [[./textos/Demostracion_por_extensionalidad.org][Las funciones f(x,y) = (x + y)² y g(x,y) = x² + 2xy + y² son iguales]] (En [[./src/Demostracion_por_extensionalidad.lean][Lean4]]).
+ X31 [[./textos/Demostracion_por_congruencia.org][En ℝ, |a| = |a - b + b|]] (En [[./src/Demostracion_por_congruencia.lean][Lean4]]).
+ J01 [[https://www.cs.us.es/~jalonso/Calculemus2024/Demostracion_por_conversion.html][En ℝ, si 1 < a, entonces a < aa]] (En [[./src/Demostracion_por_conversion.lean][Lean4]]).
