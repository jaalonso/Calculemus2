...
* Latest exercises
+ [[./textos/Limit_multiplied_by_a_constant_2.md][If the limit of the sequence u(n) is a and c ∈ ℝ, then the limit of u(n)c is ac]] (En [[./src/Limit_multiplied_by_a_constant_2.lean][Lean]]).
