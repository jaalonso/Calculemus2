...
* Latest exercises
+ [[https://jaalonso.github.io/calculemus/posts/2025/01/03-nicomachus_theorem/][Nicomachus’s theorem]] (In [[./src/Nicomachus_theorem.lean][Lean4]] and [[./thy/Nicomachus_theorem.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/12/02-tendsto_mul/][If uₙ tends to a y vₙ tends to b, then uₙvₙ tends to ab]] (In [[./src/TendsTo_mul.lean][Lean4]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/11/29-limit_multiplied_by_a_constant_2/][If the limit of the sequence u(n) is a and c ∈ ℝ, then the limit of u(n)c is ac]] (In [[./src/Limit_multiplied_by_a_constant_2.lean][Lean]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/11/10-limit_of_7u/][If u(n) tends to a, then 7u(n) tends to 7a]] (In [[./src/Limit_of_7u.lean][Lean4]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/10/07-pigeonhole_principle/][Pigeonhole principle]] (In [[./src/Pigeonhole_principle.lean][Lean4]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/10/04-if_ff_is_biyective_then_f_is_biyective/][If f ∘ f is biyective, then f is biyective]] (In [[./src/If_ff_is_biyective_then_f_is_biyective.lean][Lean]] and [[./thy/If_ff_is_biyective_then_f_is_biyective.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/09/25-brahmagupta-fibonacci_identity/][Brahmagupta-Fibonacci identity]] (In [[./src/Brahmagupta-Fibonacci_identity.lean][Lean]] and [[./thy/Brahmagupta-Fibonacci_identity.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/09/24-sum_of_powers_of_two/][Proofs of ∑k<n. 2^k = 2^n-1]] (In [[./src/Sum_of_powers_of_two.lean][Lean]] and [[./thy/Sum_of_powers_of_two.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/09/19-gausss_formula_for_summation][Proofs of "∑i<n. i = n(n-1)/2"]] (In [[./src/Gauss's_formula_for_summation.lean][Lean]] and [[./thy/Gauss's_formula_for_summation.thy][Isabelle]]).
+ [[./textos/Proofs_of_(1+p)^n_ge_1+np.md][Proofs of "If p > -1, then (1+p)ⁿ ≥ 1+np"]] (In [[./src/Proofs_of_(1+p)^n_ge_1+np.lean][Lean]] and [[./thy/Proofs_of_(1+p)^n_ge_1+np.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/09/10-sum_of_the_first_cubes/][Proofs of 0³+1³+2³+3³+···+n³ = (n(n+1)/2)²]] (In [[./src/Sum_of_the_first_cubes.lean][Lean]] and [[./thy/Sum_of_the_first_cubes.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/09/09-sum_of_geometric_progresion/][Proofs of a+aq+aq²+···+aqⁿ = a(1-qⁿ⁺¹)/(1-q)]] (In [[./src/Sum_of_geometric_progresion.lean][Lean]] and [[./thy/Sum_of_geometric_progresion.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/09/07-sum_of_arithmetic_progression/][Proofs of a+(a+d)+(a+2d)+···+(a+nd) = (n+1)(2a+nd)/2]] (In [[./src/Sum_of_arithmetic_progression.lean][Lean]] and [[./thy/Sum_of_arithmetic_progression.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/09/05-sum_of_the_first_n_natural_numbers][Proofs of 0+1+2+3+···+n = n(n+1)/2]] (In [[./src/Sum_of_the_first_n_natural_numbers.lean][Lean]] and [[./thy/Sum_of_the_first_n_natural_numbers.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/09/04-sufficient_condition_of_continuity/][If f is continuous at a and the limit of u(n) is a, then the limit of f(u(n)) is f(a)]] (In [[./src/Sufficient_condition_of_continuity.lean][Lean]] and [[./thy/Sufficient_condition_of_continuity.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/09/03-limits_are_less_than_or_equal_to_upper_bounds][If x is the limit of u and y is an upper bound of u, then x ≤ y]] (In [[./src/Limits_are_less_than_or_equal_to_upper_bounds.lean][Lean]] and [[./thy/Limits_are_less_than_or_equal_to_upper_bounds.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/09/02-le_of_forall_pos_le_add][If (∀ ε > 0, y ≤ x + ε), then y ≤ x]] (In [[./src/le_of_forall_pos_le_add.lean][Lean4]] and [[./thy/le_of_forall_pos_le_add.thy][Isabelle]]).
+ [[https://jaalonso.github.io/calculemus/posts/2024/08/31-if_x_is_the_supremum_of_set_a_then_forall_y_y_lt_x_to_exists_a_in_a_y_lt_a/][If x is the supremum of set A, then ∀ y, y < x → ∃ a ∈ A, y < a]] (In [[./src/If_x_is_the_supremum_of_set_A_then_forall_y_y_lt_x_to_exists_a_in_A_y_lt_a.lean][Lean]] and [[./thy/If_x_is_the_supremum_of_set_A_then_forall_y_y_lt_x_to_exists_a_in_A_y_lt_a.thy][Isabelle]]).
