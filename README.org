...
* Latest exercises
+ [[./textos/Nicomachus_theorem.md][Nicomachus’s theorem]] (In [[./src/Nicomachus_theorem.lean][Lean4]] and [[./thy/Nicomachus_theorem.thy][Isabelle]]).
+ [[./textos/TendsTo_mul.md][If uₙ tends to a y vₙ tends to b, then uₙvₙ tends to ab]] (In [[./src/TendsTo_mul.lean][Lean4]]).
+ [[./textos/Limit_multiplied_by_a_constant_2.md][If the limit of the sequence u(n) is a and c ∈ ℝ, then the limit of u(n)c is ac]] (In [[./src/Limit_multiplied_by_a_constant_2.lean][Lean]]).
+ [[./textos/Limit_of_7u.md][If u(n) tends to a, then 7u(n) tends to 7a]] (In [[./src/Limit_of_7u.lean][Lean4]]).
