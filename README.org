...
+ X03 [[./textos/Caracterizacion_de_menor_en_ordenes_parciales.md][En los órdenes parciales, a < b ↔ a ≤ b ∧ a ≠ b]] (En [[./src/Caracterizacion_de_menor_en_ordenes_parciales.lean][Lean4]]).
+ J04 [[./textos/Preorden_es_irreflexivo.md][Las relaciones de preorden son irreflexivas]] (En [[./src/Preorden_es_irreflexivo.lean][Lean4]]).
+ V05 [[./textos/Preorden_transitiva.md][Si ≤ es un preorden, entonces < es transitiva]] (En [[./src/Preorden_transitiva.lean][Lean4]]).
