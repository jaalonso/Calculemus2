...
+ M30 [[./textos/Demostracion_por_extensionalidad.md][Las funciones f(x,y) = (x + y)² y g(x,y) = x² + 2xy + y² son iguales]] (En [[./src/Demostracion_por_extensionalidad.lean][Lean4]]).
+ X31 [[./textos/Demostracion_por_congruencia.md][En ℝ, |a| = |a - b + b|]] (En [[./src/Demostracion_por_congruencia.lean][Lean4]]).
+ J01 [[./textos/Demostracion_por_conversion.md][En ℝ, si 1 < a, entonces a < aa]] (En [[./src/Demostracion_por_conversion.lean][Lean4]]).
