...
--
-- Se define que a es un límite de la sucesión u, por
...
--
-- Demostraremos que b ≤ a por reducción al absurdo. Supongamos que
-- b ≰ a. Sea ε = b - a. Entonces, ε/2 > 0. Puesto que a es un límite de
-- u, existe un A ∈ ℕ tal que
--    (∀n ∈ ℕ)[n ≥ A → |u(n) - a| < ε/2]                             (1)
