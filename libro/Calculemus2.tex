...
\label{sec:orgb20ae04}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org78f8f53}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orged4be3a}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org4b29c8f}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgce6d7bf}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:orga038972}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org1f96cc1}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org579001b}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orge53cc86}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org71447b7}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:org27e491e}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:org872b31c}
\begin{verbatim}
-- ---------------------------------------------------------------------
