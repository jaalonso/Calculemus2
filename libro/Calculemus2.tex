...
\label{sec:org2324f81}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org7f3f886}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org2865628}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:orgb4d3e97}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org53badfa}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org1d9a215}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org9dfc085}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:orgb1bb985}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orge379347}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org166c82b}
\begin{verbatim}
-- ---------------------------------------------------------------------
