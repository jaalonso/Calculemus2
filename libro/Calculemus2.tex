...
\label{sec:orge33a419}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org6eaf78b}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgba48577}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org434f569}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgf13f656}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:orgcdf0375}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org550947d}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org19deec8}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org1aba78d}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:orgf2ea1c9}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:org53efc11}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:orgf4287b1}
\begin{verbatim}
-- ---------------------------------------------------------------------
