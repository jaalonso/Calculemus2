...
\label{sec:org4e0cbea}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org6e29055}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org9f4a502}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:orga963a01}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org928ccf3}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:orgd178198}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org1f559c1}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org8f6fbbc}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org4f97c7e}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org9739ada}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:orga0037f9}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:orgbb1786f}
\begin{verbatim}
-- ---------------------------------------------------------------------
