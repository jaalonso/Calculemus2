...
\label{sec:org19d5934}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:orgfeeabd7}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org002bf3f}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org1d12280}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orga9cf1cb}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org89b4cf7}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org1ec761e}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org6bd28da}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org0ed0803}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org002b54d}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:orgfcb081c}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:org0675527}
\begin{verbatim}
-- ---------------------------------------------------------------------
