...
\label{sec:org9a7c52d}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org302acd6}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org574d9e3}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org223be17}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgd56fc53}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:orgbe76b22}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orge72b82d}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org2e6e4f3}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:org416e564}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:orgbfe6811}
\begin{verbatim}
-- ---------------------------------------------------------------------
