...
\label{sec:org4a8118a}

Este libro recopila los ejercicios de demostración con Lean4 que se han
publicado desde el 10 de julio de 2023 en el blog \href{https://jaalonso.github.io/calculemus}{Calculemus}.
...
incluye un enlace para interactuar con sus soluciones en \href{https://lean.math.hhu.de/}{Lean4 Web}.

Las soluciones del libro están disponibles en \href{https://github.com/jaalonso/Calculemus2}{este repositorio de
GitHub}.

El libro se actualizará periódicamente con los nuevos ejercicios que se
propongan en \href{https://jaalonso.github.io/calculemus/}{Calculemus}.

Esta obra constituye una continuación de:

\begin{itemize}
\item \href{https://raw.githubusercontent.com/jaalonso/DAO\_con\_Lean/master/DAO\_con\_Lean.pdf}{DAO (Demostración Asistida por Ordenador) con Lean}, una introducción a
la demostración con Lean3.
\item \href{https://raw.githubusercontent.com/jaalonso/Calculemus/master/Calculemus.pdf}{Calculemus (Vol. 1: Demostraciones con Isabelle/HOL y Lean3)}, que
...
\label{sec:org97e8b30}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org19e5e6e}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgf9a4c29}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:orga776ec1}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgbc8f8bb}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org083f934}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:orgabd89d3}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org4ac5bce}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org655880e}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org663c3e7}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:org65b3803}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:orgc85397a}
\begin{verbatim}
-- ---------------------------------------------------------------------
