...
\label{sec:org9f10204}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org3f1d1bc}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org22a5131}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org1cabd96}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org6e51ccc}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org3eac270}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org964bbaf}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org4b26f37}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgf7b9fe7}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:orgfc46f02}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:org5ee6e48}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:org672fa0e}
\begin{verbatim}
-- ---------------------------------------------------------------------
