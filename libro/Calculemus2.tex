...
\label{sec:orgfdbae83}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org5438abe}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org9ccbc01}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org6ea6498}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgd4e07d0}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org3d57faf}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org541c131}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org5bd54cb}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org015def2}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org8af84c4}
\begin{verbatim}
-- ---------------------------------------------------------------------
