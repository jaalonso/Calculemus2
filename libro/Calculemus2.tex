...
\label{sec:org1afcc81}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:orgaf5f205}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgef34311}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org75b0e07}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org933ce0c}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org8f463ae}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org2a7f0a6}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:orgbf278b1}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org20044ea}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:orga534be9}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:orgca6ed4e}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:org7c103b1}
\begin{verbatim}
-- ---------------------------------------------------------------------
