...
\label{sec:org3cbc568}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org293e0de}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org4a35316}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:orgabbee1f}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org72f9191}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:orga48e40e}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:orgd78d321}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org66a572a}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org1eb26b0}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:orga7f2c2a}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:orgeb45351}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:org02ab245}
\begin{verbatim}
-- ---------------------------------------------------------------------
