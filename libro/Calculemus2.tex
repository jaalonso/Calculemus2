...
\label{sec:orgb624a70}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:orgb055deb}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgf7f7bde}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org61a2a47}
\begin{verbatim}
-- ---------------------------------------------------------------------
