...
\label{sec:org32dc3ca}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org52623ad}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org7a9b803}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org3573056}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgf26c301}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:orge40c23a}
\begin{verbatim}
-- ---------------------------------------------------------------------
