...
\label{sec:orgdc302a3}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org31cd4db}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgf7a21bc}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:orgc47940a}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orge9fbd31}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org140c81a}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org10b8585}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:orgdb5460d}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgf5df38a}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org05f3c3e}
\begin{verbatim}
-- ---------------------------------------------------------------------
