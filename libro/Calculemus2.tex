...
\label{sec:orgb804a54}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:orgab40b80}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org682d4a1}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:orgd9e35d1}
\begin{verbatim}
-- ---------------------------------------------------------------------
