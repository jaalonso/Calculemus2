...
\label{sec:orgba179fd}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org47d26e9}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgf77d826}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org3e4b8bb}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgba8b19b}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org052c7d0}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:orgbe92296}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:orgf05be79}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org1ce4ce6}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org7700930}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:orgb6137bd}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:org1d9ccc0}
\begin{verbatim}
-- ---------------------------------------------------------------------
