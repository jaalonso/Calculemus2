...
\label{sec:org32d3f3e}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org0016aa6}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org9d7c299}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org7f41acc}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org3e9e4f6}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:orgad870e7}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org65fa882}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:orgf3a5109}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org785c21d}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org36a2c09}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:org5af0688}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:orge920aef}
\begin{verbatim}
-- ---------------------------------------------------------------------
