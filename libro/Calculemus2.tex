...
\label{sec:orgb8b8dd6}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:orgd70dffe}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org7e2f186}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org24826bb}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org0ebc08f}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org9e2ce96}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org5fdc499}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org42ebaaa}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgfa182bd}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org86b9b44}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:orgf369b07}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:orga4c29a2}
\begin{verbatim}
-- ---------------------------------------------------------------------
