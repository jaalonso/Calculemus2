...
\label{sec:org90511f0}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:orgf06c5fa}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org0369690}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:orgee1bb90}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org6e3ec58}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org0ae5957}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:orgee5cb1b}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:orgaf1f31f}
\begin{verbatim}
-- ---------------------------------------------------------------------
