...
\label{sec:orgeab78fc}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:orgdd13095}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org9087827}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org1ab03e4}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org1b5d5ed}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:orgf7feb5b}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:org071376e}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:orge5c171d}
\begin{verbatim}
-- ---------------------------------------------------------------------
