...
\label{sec:org17933c8}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org280df2f}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgf60fc48}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:orgd5a4fd7}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org8cf8a21}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:orgc6c5d54}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org616e935}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org75ae2b3}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org86b2466}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org82f1f9f}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:orgf673a8a}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:orgb85113a}
\begin{verbatim}
-- ---------------------------------------------------------------------
