...
\label{sec:orgf31b1ec}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:orgad7bfb3}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org77b2116}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:orgb1d4c1f}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgf58084d}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org94fdbff}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:orgb707db9}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org9c8defb}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orga0d5d8b}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org3b5262f}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:org0e333e3}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:orga61439e}
\begin{verbatim}
-- ---------------------------------------------------------------------
