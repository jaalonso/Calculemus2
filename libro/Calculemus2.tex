...
\label{sec:org049ce3b}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org2a41eaa}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org44814f8}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org0b2260f}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgbbc2812}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org70221eb}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:orga74fb11}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org1ffc225}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:org8a201c3}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:org41e16b3}
\begin{verbatim}
-- ---------------------------------------------------------------------
