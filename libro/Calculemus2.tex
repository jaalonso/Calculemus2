...
\label{sec:org3e42b33}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org166d78c}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgfc775b0}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org8139329}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org59f8e44}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org6e39d73}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:orgfd6fff8}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org033932e}
\begin{verbatim}
-- ---------------------------------------------------------------------
