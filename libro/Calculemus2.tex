...
\label{sec:orgb05ed7e}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org5c552ba}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org04fd771}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org9bfb990}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org4843839}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org50594b8}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:orgf34f34a}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:orge8cf326}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org6d30659}

\section{Si r ⊆ s y s ⊆ t, entonces r ⊆ t}
\label{sec:org96bdf23}
\begin{verbatim}
-- ---------------------------------------------------------------------
