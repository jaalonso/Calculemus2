...
\label{sec:org0079552}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:orgaa23311}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org32751ee}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:orgd64343d}
\begin{verbatim}
-- ---------------------------------------------------------------------
