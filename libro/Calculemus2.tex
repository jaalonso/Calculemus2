...
\label{sec:org2f8d1fa}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org26dcb63}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orge97ac37}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:orgb8f07ab}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org0d7f0cd}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org9e61477}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:orgba98f48}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org197021a}
\begin{verbatim}
-- ---------------------------------------------------------------------
