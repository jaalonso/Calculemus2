...
\label{sec:org9730eb6}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:org8d7db7a}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:orgbacefa2}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org1f141e5}
\begin{verbatim}
-- ---------------------------------------------------------------------
