...
\label{sec:org320af61}

\section{∀ m n ∈ ℕ, Even n → Even (m * n)}
\label{sec:orgb427a92}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org7cbf957}

\section{En ℝ, (ab)c = b(ac)}
\label{sec:org07085e4}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\label{sec:org6321957}

\section{Si x,y,z ∈ ℕ, entonces x ∣ yxz}
\label{sec:org10cf42f}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Retículos}
\label{sec:org2f2ce61}

\section{En los retículos, x ⊓ y = y ⊓ x}
\label{sec:org7ddd6a6}
\begin{verbatim}
-- ---------------------------------------------------------------------
...
\chapter{Lógica}
\label{sec:orge91bef1}

\section{Si ¬(∃x)P(x), entonces (∀x)¬P(x)}
\label{sec:org4d9de32}
\begin{verbatim}
-- ---------------------------------------------------------------------
